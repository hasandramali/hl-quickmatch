...
void CBasePlayerWeapon::ItemPostFrame( void )
{
	...
	if( bSecondaryDown && !( m_pPlayer->pev->button & IN_RUN ) && ( m_flNextSecondaryAttack <= 0.0f ) )
	{
	...
	else if( ( ( bUseSemiAutoPrimary ? bPrimaryPressed : bPrimaryDown ) ) && !( m_pPlayer->pev->button & IN_RUN ) && ( m_flNextPrimaryAttack <= 0.0f ) )
	{
